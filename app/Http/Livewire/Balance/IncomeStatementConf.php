...
class IncomeStatementConf extends Component
{
    ...
    public function render()
    {
        ...
        $incomeStatementConf = IncomeStatementConfDB::where('group', null)->get();

        return view('livewire.balance.income-statement-conf', compact('incomeStatementConf'));
    }
    ...
    public function destroy($id){
      IncomeStatementConfDB::destroy($id);
