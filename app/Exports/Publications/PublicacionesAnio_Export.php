...
class PublicacionesAnio_Export implements FromView, WithTitle, WithEvents, ShouldAutoSize
{
    protected $titulo;
    ...
    {
        return view('pdf-reports.publicaciones.publicaciones-anio-estrategico-excel', [
