    ...
    <table class="table table-hover ">
        <thead class="thead-dark">
            <tr>
              ...
              <th  width="200px">Cuenta</th>
              <th >Nombre</th>
              <th width="200px" class="text-center">Padre</th>
                ...
                @foreach ($data as $key => $value)
                    <tr>
                       <td>{{$key+1}}</td>
                        ...
                        <td>
                          <button wire:click="get({{$value->id}})" data-mdb-toggle="modal" data-mdb-target="#delete" type="button" class="btn btn-danger">
