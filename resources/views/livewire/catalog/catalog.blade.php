      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <!--SE IMPRIME LA TABLA DE CONTENIDO-->
           @include('livewire.catalog.table-catalog')
           <!--SE IMPRIME LA TABLA DE CONTENIDO-->
        </div>

        <!--SE INCLUYE LOS ARCHIVOS BLADE ADICIONALES PARA MOSTRAR MODALES COMO AGREGAR, ELIMINAR, EDITAR-->
        <div class="col-md-12">
           @include('livewire.catalog.create-catalog')
           @include('livewire.catalog.delete-catalog')
           @include('livewire.catalog.edit-catalog')
        </div>
        <!--SE INCLUYE LOS ARCHIVOS BLADE ADICIONALES PARA MOSTRAR MODALES COMO AGREGAR, ELIMINAR, EDITAR-->
