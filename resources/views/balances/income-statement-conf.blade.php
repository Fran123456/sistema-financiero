<x-app-layout>
   ...
   <div class="col-md-12">
     <nav aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active" aria-current="page">Estado de resultado para:  {{$company->company}}</li>
       </ol>
     </nav>
   </div>
  </div>
  ...
  <div class="row card">
    <!--componente de usuarios-->
      ...
      <div class="card-body">
        <p class="card-text">
         @livewire('balance.income-statement-conf' ,['company_id'=> $company->id])
        </p>
      </div>
    <!--componente de usuarios-->
  </div>
